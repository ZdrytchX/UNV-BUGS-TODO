ZdrytchX's overfucked list of stuff that he wants changed, personal wanted removal and actual exploits/bugs etc.
...
-Jetpack "Random" recovery timer always returns false, hence the recovery time is always one second
